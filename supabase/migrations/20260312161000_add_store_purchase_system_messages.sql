...
begin
  ...
  values (
    ...
    null,
    'system',
    coalesce(v_nickname, 'Someone') || ' bought a background for ' || coalesce(v_pet_name, 'the pet') || '.'
  );
...
begin
  ...
  values (
    ...
    null,
    'system',
    coalesce(v_nickname, 'Someone') || ' bought furniture for ' || coalesce(v_pet_name, 'the pet') || '.'
  );
