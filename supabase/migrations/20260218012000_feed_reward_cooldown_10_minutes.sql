-- Change feed coin reward cooldown from 1 hour to 10 minutes.
-- Keep clean with no cooldown, and keep touch/ad_reward at 1 hour.
...
begin
  ...
  if p_action_type in ('touch', 'ad_reward')
    and v_last is not null
