...
- Crown head equipment is wired app-side and live catalog-side with a
  version-gated 1.4.0 shop migration; it reuses existing head sockets until
  Godot fine-tuning.
...
- Force update, What's New, crash fallback, and ATT-aware AdMob remain separate
  flows.
- GEOFlow, multilingual SEO/GEO guides, Firebase Hosting static marketing
  pages, support/legal pages, invite fallback pages, app/universal-link files,
  and related automation now live in `/Users/fatboy/geo-marketing`, not this
  Flutter app repo.
...
- For GEOFlow/SEO/Firebase Hosting work, use `/Users/fatboy/geo-marketing`.
  PetTomo-specific publishing lives under
