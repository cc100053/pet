...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "purchases_ui_flutter", path: "../ephemeral/Packages/.packages/purchases_ui_flutter-10.13.2"),
        .package(name: "purchases_flutter", path: "../ephemeral/Packages/.packages/purchases_flutter-10.13.2"),
