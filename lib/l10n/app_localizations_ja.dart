...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get errorMediaPermissionDenied =>
      'カメラまたは写真へのアクセスがオフになっています。設定で許可してからもう一度お試しください。';
  ...
  @override
  String get roomSelectionStatusHungry => 'おなかすいた';

  @override
  String get roomSelectionStatusNewPhoto => '新しい写真';
  ...
  String roomFrameLockedLevelHint(Object frameName, int level) {
    return '$frameName はルーム Lv $level で解放されます。';
  }
  ...
  String get furnitureInventoryHint =>
      '家具をタップして配置。配置済みの家具を選ぶと移動、サイズ調整、反転ができます。';
  ...
  @override
  String get whatsNew232Bullet1 => '不具合を修正し、アプリの安定性を改善しました。';

  @override
  String get whatsNew232Bullet2 => '日常利用がより快適になるよう信頼性を向上しました。';
