...
- [ ] Archive pre-compaction memory/task snapshots and keep active files
...
- [ ] Record line-count changes, inspect the full diff, and run required
      Flutter verification.
- [ ] Commit and push all legitimate changes, verify the remote branch, and
