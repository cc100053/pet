...
For provisional versus human-reviewed exports, follow the generation threshold
policy in the [calibration skill](../.codex/skills/pet-socket-calibration/SKILL.md).
Human-reviewed movement must not be discarded because it falls below the
...
□ Preserve reviewed movement using the calibration skill's generation threshold policy
